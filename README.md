...
### Olá, mundo! 👋  
Sou **Gustavo Reis**, um entusiasta de tecnologia em transição de carreira, atualmente cursando **Análise e Desenvolvimento de Sistemas** no SENAC com formação prévia em **Técnico em Edificações**. Natural de **Mogi das Cruzes - SP**, hoje em **Ponta Grossa - PR**, sou movido pela paixão por **dados, soluções tecnológicas e desafios complexos**. Busco constantemente explorar novas tecnologias e desenvolver soluções inovadoras que gerem impacto real.

---

## 🚀 Sobre Mim
- 🎓 **Formação:** ADS - SENAC (cursando) | Técnico em Edificações
- 💻 **Foco Atual:** Análise de dados, BI, automação com Python e desenvolvimento web (Django, Laravel)
- 🛠️ **Skills Complementares:** Suporte técnico, formatação de máquinas, otimização de sistemas Linux
- 🎮 **Interesses Pessoais:** Experimentação com distros Linux, contribuição para projetos open source e games
...
- **[Portal Informativo Regional](https://github.com/Gustavo-Rei/estadoBrasil)** → Site responsivo com informações geográficas e culturais de Santa Catarina
- **[Jogo Interativo Browser](https://github.com/Gustavo-Rei/ballGame)** → Game desenvolvido em TypeScript com elementos interativos e sistema de pontuação

🔍 **Explore mais projetos:** [Repositórios GitHub](https://github.com/Gustavo-Rei?tab=repositories)

---

## 💼 Experiência Profissional

**Assistente Administrativo** — *Superzelo Inteligência Condominial* · Ponta Grossa, PR *(2023 – Atual)*  
→ Desenvolvimento de solução simples de BI  
→ Gestão de planilhas e documentos  

**Jovem Aprendiz** — *Hubner Componentes Automotivos* · Ponta Grossa, PR *(2022 – 2023)*  
→ Emissão de relatórios e controle de documentos  
→ Auxílio na organização e conferência de dados em planilhas  
